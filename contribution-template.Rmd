...
cbind(
  ...
  save_kable("tex/table_result.tex")
...
file.copy(
  "tex/table_result.tex",
  "tex/table_result_doc.tex",
  overwrite = TRUE
  )

fConn <- file("tex/table_result_doc.tex", "r+")
...
tools::texi2dvi(file = "tex/table_result_doc.tex")
cmd <- paste(
  "dvipng -T tight", 
  shQuote("table_result_doc.dvi"),
  "-o", shQuote("table_figures/table_result.png")
  )
invisible(system(cmd))
cleaner <- c(".aux", ".log", ".dvi")
invisible(file.remove(paste0("table_result_doc", cleaner)))

```

![](table_figures/table_result.png){width=100%}
