...
If your are using [our template Markdown file](https://github.com/worldbank/r-econ-visual-library/blob/master/contribution-template.Rmd), the HTML file and the tables will be automatically saved in the correct folder, as long as the Markdown file is saved in the _Library_ folder.
